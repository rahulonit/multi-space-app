...
namespace PINGGO.Models
{
    ...
    public class SocialPlatform
    {
        ...
        public static List<SocialPlatform> DefaultPlatforms => new()
        {
            ...
            new SocialPlatform { Id = "instagram", Name = "Instagram", OfficialIdentityId = "instagram", Symbol = "camera.fill", Color = "pink", WebsiteURL = "https://www.instagram.com", Categories = new() { "Social" } },
            new SocialPlatform { Id = "twitter", Name = "X (Twitter)", OfficialIdentityId = "twitter", Symbol = "bubble.left.fill", Color = "black", WebsiteURL = "https://x.com/home", Categories = new() { "Social" } },
            ...
            new SocialPlatform { Id = "reddit", Name = "Reddit", OfficialIdentityId = "reddit", Symbol = "bubble.left.and.bubble.right.fill", Color = "orange", WebsiteURL = "https://www.reddit.com", Categories = new() { "Community" } },
            ...
            new SocialPlatform { Id = "linkedin", Name = "LinkedIn", OfficialIdentityId = "linkedin", Symbol = "briefcase.fill", Color = "blue", WebsiteURL = "https://www.linkedin.com/feed/", Categories = new() { "Work", "Professional" } },
